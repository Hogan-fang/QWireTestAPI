...
import io.qwire.trace.QWireTraceTestBase;
...
public class BaseApiCaseExecutor extends QWireTraceTestBase implements CaseExecutor {
    ...
    public boolean supports(String serviceName, ITestContext testContext) {
        ...
        if (resolvedServiceName == null || resolvedServiceName.isBlank()) {
            throw new IllegalStateException("Executor class must declare static SERVICE_NAME");
        }
